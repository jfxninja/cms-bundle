...
class Field  {
     ...
     * Set gridNewRow
     *
     * @param boolean $gridNewRow
     * @return Field
     */
    public function setGridNewRow($gridNewRow)
    {
        $this->gridNewRow = $gridNewRow;
     ...
     * @return boolean 
     */
    public function getGridNewRow()
    {
        return $this->gridNewRow;
    }

    /**
     * Set gridColsSmall
     *
     * @param string $gridColsSmall
     * @return Field
     */
    public function setGridColsSmall($gridColsSmall)
    {
        $this->gridColsSmall = $gridColsSmall;
     ...
     * @return string 
     */
    public function getGridColsSmall()
    {
        return $this->gridColsSmall;
    }

    /**
     * Set gridColsMedium
     *
     * @param string $gridColsMedium
     * @return Field
     */
    public function setGridColsMedium($gridColsMedium)
    {
        $this->gridColsMedium = $gridColsMedium;
     ...
     * @return string 
     */
    public function getGridColsMedium()
    {
        return $this->gridColsMedium;
    }

    /**
     * Set gridColsLarge
     *
     * @param string $gridColsLarge
     * @return Field
     */
    public function setGridColsLarge($gridColsLarge)
    {
        $this->gridColsLarge = $gridColsLarge;
